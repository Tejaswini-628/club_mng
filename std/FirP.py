...
class Firstpage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        border = tk.LabelFrame(self, text=' Student  Login ', bg='#F1F0E8', bd=10, font=('Arial', 18))
        ...
        def verify():
            ...
            if username == '' or password == '':
                ...
                sqlquery = "SELECT id, username, password FROM student WHERE username=%s and password=%s"
                ...
                if result: 
                    ...
                    controller.show_frame(Secondpage, username=username)
            ...
            def insertData():
                if entry_username.get()!="" or entry_password.get()!="" or entry_cpassword.get()!="":
                    if entry_password.get()==entry_cpassword.get():
                        ...
                        insert_query = "INSERT INTO `student` (`username`, `password`, `cpassword`) VALUES (%s, %s, %s)"
